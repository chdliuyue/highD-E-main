            ...
            events.append(
                {
                    ...
                    "E_vtm_CO2": _integrate_rate(window_df.get("vtm_co2_rate", pd.Series(dtype=float)), frame_rate),
                    "E_vtm_NOx": _integrate_rate(window_df.get("vtm_nox_rate", pd.Series(dtype=float)), frame_rate),
